            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <a href="{{ route('device') }}"><i class="fa fa-times-circle fa-lg" aria-hidden="true"></i></a>
                    </button>
                    <h4 class="modal-title">Новая запись</h4>
                </div>
                {!! Form::open(['url' => route('deviceAdd'),'class'=>'form-horizontal','method'=>'POST','id'=>'new_val','enctype'=>'multipart/form-data']) !!}
                <div class="modal-body">

                    <div class="form-group">
                        {!! Form::label('name', 'Наименование:',['class'=>'col-xs-3 control-label']) !!}
                        <div class="col-xs-9">
                            {!! Form::text('name', old('name'),['class' => 'form-control','placeholder'=>'Введите наименование','required'=>'required','maxlength'=>'70','id'=>'name'])!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            {!! Form::select('type_id',$typesel, old('type_id'), ['class' => 'form-control','required'=>'required','id'=>'typeid']); !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            {!! Form::select('protocol_id',$protsel, old('protocol_id'), ['class' => 'form-control','required'=>'required','id'=>'protocolid']); !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            {!! Form::select('location_id',$locsel, old('location_id'), ['class' => 'form-control','required'=>'required','id'=>'locationid']); !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            {!! Form::select('verify',['0'=>'Ручной','1'=>'Автоматический'], old('verify'), ['class' => 'form-control','required'=>'required','id'=>'verify']); !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            {!! Form::select('status',['0'=>'Отключено','1'=>'В работе'], old('status'), ['class' => 'form-control','required'=>'required','id'=>'status']); !!}
                ...
                <div class="modal-footer">
                    <a href="{{ route('device') }}"><button type="button" class="btn btn-default" data-dismiss="modal">Отмена</button></a>
