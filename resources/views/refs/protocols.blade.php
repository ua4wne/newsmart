...
@section('content')
    ...
    <ul class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('protocol') }}">{{ $title }}</a></li>
    </ul>
    <!-- END BREADCRUMB -->
    <!-- page content -->
    <div class="row">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            {!! Form::label('code', 'Код EN:',['class'=>'col-xs-3 control-label']) !!}
                            <div class="col-xs-9">
                                {!! Form::text('code', old('code'),['class' => 'form-control','placeholder'=>'Введите уникальный код','required'=>'required','maxlength'=>'7','id'=>'code'])!!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                {!! Form::text('name', old('name'),['class' => 'form-control','placeholder'=>'Введите наименование','required'=>'required','maxlength'=>'30','id'=>'name'])!!}
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            {!! Form::label('code', 'Код EN:',['class'=>'col-xs-3 control-label']) !!}
                            <div class="col-xs-9">
                                {!! Form::text('code', old('code'),['class' => 'form-control','placeholder'=>'Введите уникальный код','required'=>'required','maxlength'=>'7','id'=>'ecode'])!!}
                                {!! $errors->first('code', '<p class="text-danger">:message</p>') !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            {!! Form::label('name', 'Наименование:',['class'=>'col-xs-3 control-label']) !!}
                            <div class="col-xs-9">
                                {!! Form::text('name', old('name'),['class' => 'form-control','placeholder'=>'Введите наименование','required'=>'required','maxlength'=>'30','id'=>'ename'])!!}
                                {!! $errors->first('name', '<p class="text-danger">:message</p>') !!}
                            </div>
                        </div>
                ...
                <div class="btn-group">
                    <a href="#">
                        <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#addNew">
                            <i class="fa fa-plus green" aria-hidden="true"></i> Новый протокол
                        </button>
                    </a>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td style="width:100px;">
                                <div class="form-group" role="group" id="{{ $row->id }}">
                                    <button class="btn btn-success btn-sm val_edit" type="button" data-toggle="modal"
                                            data-target="#editVal" title="Редактировать запись"><i class="fa fa-edit"
                                                                                                   aria-hidden="true"></i>
                                    </button>
                                    <button class="btn btn-danger btn-sm val_delete" type="button"
                                            title="Удалить запись"><i class="fa fa-trash" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </td>
                        </tr>
    ...
    <script>
        ...
        $(document).on({
            click: function () {
                ...
                var code = $(this).parent().parent().prevAll().eq(1).text();
